...
/* Controllers */
  // signin controller
app.controller('PaymentSandBoxController', ['$scope', '$http', '$state', 'MyService',function($scope, $http,$state,MyService) {
    ...
    $scope.payment=function(item){
      ...
      $http({
        method:'POST',
        // url:'http://sohigh.com.ve/libs/payeezy_php/payeezy_paymentSandBox.php',
        url:'libs/payeezy_php/payeezy_paymentSandBox.php',
...
$scope.genAl(); 
    ...
    $scope.okSale=function(item){
      ...
      saleObj.idSale=$scope.prov.folder.toString();
