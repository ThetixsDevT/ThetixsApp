...
$scope.genAl(); 
    ...
    $scope.okSale=function(item){
      ...
      // saleObj.productsListComplete=MyService.d);
// ata.productsListComplete;
    ...
    $scope.chargeCardWithNonce = function(nonce) {
      ...
      var url = "libs/square_php_payment/process-card.php";
      ...
      var data = {
       ...
       $http({
        method:'POST',
        url:'libs/square_php_payment/process-card.php',
