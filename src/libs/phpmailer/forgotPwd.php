        ...
        <div align="center" style="display:inline-block;
          ...
          <div style="border-radius:10px; width: 320PX; box-shadow:5px 5px 17px 0px rgba(44, 50, 50, 0.14);">
            <table style=" color: #4a4646; margin:0px; padding:20px; max-width:300px;">
              ...
              <tr>
               <td>Pass:</td>
               <td style="background-color:#7de7fe4d;ali:5px;border-radius:5px; border-radius: 10px;" align="center"><h3>'.$_POST['password'].'</h3>
               </td>
              </tr>
            </table>
          </div>
          ...
          <div style="
            ...
            <div align="center" style="padding:10px;" >
               <h4 style="color:#fff;  "> 
                  <a href="http://thetixs.com" style="color:#fff;">The|Tixs Team
                  </a>
               </h4>
            </div>
          </div>
